...
/* FxnTable */
struct ti_sdo_ipc_family_c647x_Interrupt_FxnTable {
    xdc_Fxn func;
    xdc_UArg arg;
};

/* Module_State */
typedef ti_sdo_ipc_family_c647x_Interrupt_FxnTable __T1_ti_sdo_ipc_family_c647x_Interrupt_Module_State__fxnTable;
typedef ti_sdo_ipc_family_c647x_Interrupt_FxnTable *__ARRAY1_ti_sdo_ipc_family_c647x_Interrupt_Module_State__fxnTable;
typedef __ARRAY1_ti_sdo_ipc_family_c647x_Interrupt_Module_State__fxnTable __TA_ti_sdo_ipc_family_c647x_Interrupt_Module_State__fxnTable;
...
struct ti_sdo_ipc_family_c647x_Interrupt_Module_State {
    __TA_ti_sdo_ipc_family_c647x_Interrupt_Module_State__fxnTable fxnTable;
    xdc_UInt numPlugged;
};
...
#define Interrupt_FxnTable ti_sdo_ipc_family_c647x_Interrupt_FxnTable
