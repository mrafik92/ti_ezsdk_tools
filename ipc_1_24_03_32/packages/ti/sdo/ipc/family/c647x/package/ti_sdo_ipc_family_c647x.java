...
public class ti_sdo_ipc_family_c647x
{
    ...
    void Interrupt$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sdo.ipc.family.c647x.Interrupt$$FxnTable", new Proto.Obj());
        om.bind("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", new Proto.Str(spo, false));
    ...
    void Interrupt$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "ti.sdo.ipc.family.c647x");
        sizes.clear();
        sizes.add(Global.newArray("func", "UFxn"));
        sizes.add(Global.newArray("arg", "UIArg"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sdo.ipc.family.c647x.Interrupt.FxnTable']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sdo.ipc.family.c647x.Interrupt.FxnTable']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sdo.ipc.family.c647x.Interrupt.FxnTable'], fld); }");
    ...
    void Interrupt$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.c647x.Interrupt$$FxnTable", "ti.sdo.ipc.family.c647x");
        po.init("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        ...
        po.init("ti.sdo.ipc.family.c647x.Interrupt.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("fxnTable", new Proto.Arr((Proto)om.findStrict("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "ti.sdo.ipc.family.c647x"), false), $$DEFAULT, "w");
    ...
    void Interrupt$$ROV()
    {
        ...
        vo.bind("FxnTable$fetchDesc", Global.newObject("type", "ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.c647x.Interrupt$$FxnTable", "ti.sdo.ipc.family.c647x");
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.sdo.ipc.family.c647x.Interrupt.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.c647x.Interrupt$$Module_State", "ti.sdo.ipc.family.c647x");
        po.bind("fxnTable$fetchDesc", Global.newObject("type", "ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "isScalar", false));
    }
    ...
    void Interrupt$$SINGLETONS()
    {
        ...
        vo.bind("FxnTable", om.findStrict("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "ti.sdo.ipc.family.c647x"));
        tdefs.add(om.findStrict("ti.sdo.ipc.family.c647x.Interrupt.FxnTable", "ti.sdo.ipc.family.c647x"));
