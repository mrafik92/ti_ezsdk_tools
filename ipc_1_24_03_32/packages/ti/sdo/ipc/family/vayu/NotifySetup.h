...
/* dspIntVectId0 */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0__D
#define ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0 (ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0 (ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0 ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0__C;
#endif

/* dspIntVectId1 */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1__D
#define ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1 (ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1 (ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1 ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1__C;
#endif
...
typedef xdc_UInt32 __ARRAY1_ti_sdo_ipc_family_vayu_NotifySetup_procIdTable[8];
...
/* videoProcId */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_videoProcId__D
#define ti_sdo_ipc_family_vayu_NotifySetup_videoProcId (ti_sdo_ipc_family_vayu_NotifySetup_videoProcId__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_videoProcId (ti_sdo_ipc_family_vayu_NotifySetup_videoProcId__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_videoProcId;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_videoProcId ti_sdo_ipc_family_vayu_NotifySetup_videoProcId__C;
#endif

/* vpssProcId */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId__D
#define ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId (ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId (ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId__C;
#endif
...
/* module prefix */
#define NotifySetup_dspIntVectId0 ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId0
#define NotifySetup_dspIntVectId1 ti_sdo_ipc_family_vayu_NotifySetup_dspIntVectId1
...
#define NotifySetup_videoProcId ti_sdo_ipc_family_vayu_NotifySetup_videoProcId
#define NotifySetup_vpssProcId ti_sdo_ipc_family_vayu_NotifySetup_vpssProcId
