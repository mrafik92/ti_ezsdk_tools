...
public class ti_sdo_ipc
{
    ...
    void Ipc$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sdo.ipc.Ipc$$ConfigHead", new Proto.Obj());
        om.bind("ti.sdo.ipc.Ipc.ConfigHead", new Proto.Str(spo, false));
    ...
    void Ipc$$SIZES()
    {
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.sdo.ipc.Ipc.ConfigHead", "ti.sdo.ipc");
        sizes.clear();
        sizes.add(Global.newArray("first", "UInt32"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sdo.ipc.Ipc.ConfigHead']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sdo.ipc.Ipc.ConfigHead']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sdo.ipc.Ipc.ConfigHead'], fld); }");
        so.bind("$offsetof", fxn);
    ...
    void Ipc$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("sr0MemorySetup", $$T_Bool, $$UNDEF, "wh");
        ...
        po.init("ti.sdo.ipc.Ipc.ConfigEntry", null);
                ...
                po.addFld("next", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
        // struct Ipc.ConfigHead
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.Ipc$$ConfigHead", "ti.sdo.ipc");
        po.init("ti.sdo.ipc.Ipc.ConfigHead", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("first", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
        // struct Ipc.ProcEntry
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.Ipc$$ProcEntry", "ti.sdo.ipc");
        po.init("ti.sdo.ipc.Ipc.ProcEntry", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("localConfigList", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("remoteConfigList", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
    ...
    void Ipc$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.Ipc$$ConfigEntry", "ti.sdo.ipc");
        vo.bind("ConfigHead$fetchDesc", Global.newObject("type", "ti.sdo.ipc.Ipc.ConfigHead", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.Ipc$$ConfigHead", "ti.sdo.ipc");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/ti.sdo.ipc.aem3',\n");
            sb.append("'lib/debug/ti.sdo.ipc.ae674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/debug/ti.sdo.ipc.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/debug/ti.sdo.ipc.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void GateMP$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_GateMP_Handle__label__E", "ti_sdo_ipc_GateMP_Module__startupDone__E", "ti_sdo_ipc_GateMP_Object__create__E", "ti_sdo_ipc_GateMP_Object__delete__E", "ti_sdo_ipc_GateMP_Object__destruct__E", "ti_sdo_ipc_GateMP_Object__get__E", "ti_sdo_ipc_GateMP_Object__first__E", "ti_sdo_ipc_GateMP_Object__next__E", "ti_sdo_ipc_GateMP_Params__init__E", "ti_sdo_ipc_GateMP_createLocal__E", "ti_sdo_ipc_GateMP_attach__E", "ti_sdo_ipc_GateMP_getRegion0ReservedSize__E", "ti_sdo_ipc_GateMP_setRegion0Reserved__E", "ti_sdo_ipc_GateMP_openRegion0Reserved__E", "ti_sdo_ipc_GateMP_setDefaultRemote__E", "ti_sdo_ipc_GateMP_start__E", "ti_sdo_ipc_GateMP_getSharedAddr__E"));
    ...
    void MessageQ$$SINGLETONS()
    {
        ...
        vo.bind("$$errorDescCfgs", Global.newArray("E_maxReached", "E_unregisterHeapId", "E_nameFailed"));
    ...
    void SharedRegion$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_SharedRegion_Module__startupDone__E", "ti_sdo_ipc_SharedRegion_attach__E", "ti_sdo_ipc_SharedRegion_clearReservedMemory__E", "ti_sdo_ipc_SharedRegion_reserveMemory__E", "ti_sdo_ipc_SharedRegion_resetInternalFields__E", "ti_sdo_ipc_SharedRegion_start__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
    ...
    void Ipc$$SINGLETONS()
    {
        ...
        vo.bind("ConfigHead", om.findStrict("ti.sdo.ipc.Ipc.ConfigHead", "ti.sdo.ipc"));
        tdefs.add(om.findStrict("ti.sdo.ipc.Ipc.ConfigHead", "ti.sdo.ipc"));
