...
/* ConfigHead */
struct ti_sdo_ipc_Ipc_ConfigHead {
    volatile xdc_Bits32 first;
};

/* ProcEntry */
struct ti_sdo_ipc_Ipc_ProcEntry {
    xdc_Ptr localConfigList;
    xdc_Ptr remoteConfigList;
    xdc_UInt attached;
...
#define Ipc_ConfigHead ti_sdo_ipc_Ipc_ConfigHead
