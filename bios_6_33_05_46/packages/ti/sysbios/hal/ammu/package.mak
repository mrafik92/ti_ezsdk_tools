...
override PKGDIR = ti/sysbios/hal/ammu
...
package/%.xdc.inc package/%_ti.sysbios.hal.ammu.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sysbios.hal.ammu" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sysbios.hal.ammu $@

.libraries,em3 .libraries: lib/debug/ti.sysbios.hal.ammu.aem3

-include lib/debug/ti.sysbios.hal.ammu.aem3.mak
lib/debug/ti.sysbios.hal.ammu.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sysbios.hal.ammu/package/package_ti.sysbios.hal.ammu.oem3 package/lib/lib/debug/ti.sysbios.hal.ammu/AMMU.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/ti.sysbios.hal.ammu/package/package_ti.sysbios.hal.ammu.oem3 package/lib/lib/debug/ti.sysbios.hal.ammu/AMMU.oem3 
lib/debug/ti.sysbios.hal.ammu.aem3: export C_DIR=
lib/debug/ti.sysbios.hal.ammu.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/debug/ti.sysbios.hal.ammu.aem3
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sysbios.hal.ammu.oem3,copy : package/lib/lib/debug/ti.sysbios.hal.ammu/package/package_ti.sysbios.hal.ammu.oem3
package_ti.sysbios.hal.ammu.sem3,copy : package/lib/lib/debug/ti.sysbios.hal.ammu/package/package_ti.sysbios.hal.ammu.sem3
AMMU.oem3,copy : package/lib/lib/debug/ti.sysbios.hal.ammu/AMMU.oem3
AMMU.sem3,copy : package/lib/lib/debug/ti.sysbios.hal.ammu/AMMU.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sysbios_hal_ammu
ti_sysbios_hal_ammu.tar: package/package.bld.xml
ti_sysbios_hal_ammu.tar: package/package.ext.xml
ti_sysbios_hal_ammu.tar: package/package.rel.dot
ti_sysbios_hal_ammu.tar: package/build.cfg
ti_sysbios_hal_ammu.tar: package/package.xdc.inc
ti_sysbios_hal_ammu.tar: package.bld
ti_sysbios_hal_ammu.tar: linkcmd.xdt
ti_sysbios_hal_ammu.tar: AMMU_link.xdt
ti_sysbios_hal_ammu.tar: package/package.cfg.xdc.inc
ti_sysbios_hal_ammu.tar: lib/debug/ti.sysbios.hal.ammu.aem3
ti_sysbios_hal_ammu.tar: package/package_ti.sysbios.hal.ammu.c
ti_sysbios_hal_ammu.tar: AMMU.c
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sysbios_hal_ammu.tar.dep
endif
package/rel/ti_sysbios_hal_ammu/ti/sysbios/hal/ammu/package/package.rel.xml:

ti_sysbios_hal_ammu.tar: package/rel/ti_sysbios_hal_ammu.xdc.inc package/rel/ti_sysbios_hal_ammu/ti/sysbios/hal/ammu/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sysbios_hal_ammu.xdc.inc,package/rel/ti_sysbios_hal_ammu.tar.dep)


release release,ti_sysbios_hal_ammu: all ti_sysbios_hal_ammu.tar
clean:: .clean
	-$(RM) ti_sysbios_hal_ammu.tar
	-$(RM) package/rel/ti_sysbios_hal_ammu.xdc.inc
	-$(RM) package/rel/ti_sysbios_hal_ammu.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.hal.ammu))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.hal.ammu)
endif
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.hal.ammu/package))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.hal.ammu/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sysbios.hal.ammu.pjt
