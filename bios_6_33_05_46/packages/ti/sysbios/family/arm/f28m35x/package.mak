...
override PKGDIR = ti/sysbios/family/arm/f28m35x
...
package/%.xdc.inc package/%_ti.sysbios.family.arm.f28m35x.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sysbios.family.arm.f28m35x" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sysbios.family.arm.f28m35x $@

.libraries,em3 .libraries: lib/debug/ti.sysbios.family.arm.f28m35x.aem3

-include lib/debug/ti.sysbios.family.arm.f28m35x.aem3.mak
lib/debug/ti.sysbios.family.arm.f28m35x.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package/package_ti.sysbios.family.arm.f28m35x.oem3 package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/TimestampProvider.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package/package_ti.sysbios.family.arm.f28m35x.oem3 package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/TimestampProvider.oem3 
lib/debug/ti.sysbios.family.arm.f28m35x.aem3: export C_DIR=
lib/debug/ti.sysbios.family.arm.f28m35x.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/debug/ti.sysbios.family.arm.f28m35x.aem3
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sysbios.family.arm.f28m35x.oem3,copy : package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package/package_ti.sysbios.family.arm.f28m35x.oem3
package_ti.sysbios.family.arm.f28m35x.sem3,copy : package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package/package_ti.sysbios.family.arm.f28m35x.sem3
TimestampProvider.oem3,copy : package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/TimestampProvider.oem3
TimestampProvider.sem3,copy : package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/TimestampProvider.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sysbios_family_arm_f28m35x
ti_sysbios_family_arm_f28m35x.tar: package/package.bld.xml
ti_sysbios_family_arm_f28m35x.tar: package/package.ext.xml
ti_sysbios_family_arm_f28m35x.tar: package/package.rel.dot
ti_sysbios_family_arm_f28m35x.tar: package/build.cfg
ti_sysbios_family_arm_f28m35x.tar: package/package.xdc.inc
ti_sysbios_family_arm_f28m35x.tar: package.bld
ti_sysbios_family_arm_f28m35x.tar: TimestampProvider.xml
ti_sysbios_family_arm_f28m35x.tar: package/package.cfg.xdc.inc
ti_sysbios_family_arm_f28m35x.tar: lib/debug/ti.sysbios.family.arm.f28m35x.aem3
ti_sysbios_family_arm_f28m35x.tar: package/package_ti.sysbios.family.arm.f28m35x.c
ti_sysbios_family_arm_f28m35x.tar: TimestampProvider.c
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sysbios_family_arm_f28m35x.tar.dep
endif
package/rel/ti_sysbios_family_arm_f28m35x/ti/sysbios/family/arm/f28m35x/package/package.rel.xml:

ti_sysbios_family_arm_f28m35x.tar: package/rel/ti_sysbios_family_arm_f28m35x.xdc.inc package/rel/ti_sysbios_family_arm_f28m35x/ti/sysbios/family/arm/f28m35x/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sysbios_family_arm_f28m35x.xdc.inc,package/rel/ti_sysbios_family_arm_f28m35x.tar.dep)


release release,ti_sysbios_family_arm_f28m35x: all ti_sysbios_family_arm_f28m35x.tar
clean:: .clean
	-$(RM) ti_sysbios_family_arm_f28m35x.tar
	-$(RM) package/rel/ti_sysbios_family_arm_f28m35x.xdc.inc
	-$(RM) package/rel/ti_sysbios_family_arm_f28m35x.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.family.arm.f28m35x))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.family.arm.f28m35x)
endif
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.family.arm.f28m35x/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sysbios.family.arm.f28m35x.pjt
