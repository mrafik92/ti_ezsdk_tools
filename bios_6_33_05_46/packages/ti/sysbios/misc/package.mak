...
override PKGDIR = ti/sysbios/misc
...
package/%.xdc.inc package/%_ti.sysbios.misc.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sysbios.misc" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sysbios.misc $@

.libraries,em3 .libraries: lib/debug/ti.sysbios.misc.aem3

-include lib/debug/ti.sysbios.misc.aem3.mak
lib/debug/ti.sysbios.misc.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oem3 package/lib/lib/debug/ti.sysbios.misc/Stats.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oem3 package/lib/lib/debug/ti.sysbios.misc/Stats.oem3 
lib/debug/ti.sysbios.misc.aem3: export C_DIR=
lib/debug/ti.sysbios.misc.aem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 clean::
	-$(RM) lib/debug/ti.sysbios.misc.aem3
.libraries,e674 .libraries: lib/debug/ti.sysbios.misc.ae674

-include lib/debug/ti.sysbios.misc.ae674.mak
lib/debug/ti.sysbios.misc.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oe674 package/lib/lib/debug/ti.sysbios.misc/Stats.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oe674 package/lib/lib/debug/ti.sysbios.misc/Stats.oe674 
lib/debug/ti.sysbios.misc.ae674: export C_DIR=
lib/debug/ti.sysbios.misc.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/debug/ti.sysbios.misc.ae674
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sysbios.misc.oem3,copy : package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oem3
package_ti.sysbios.misc.sem3,copy : package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.sem3
Stats.oem3,copy : package/lib/lib/debug/ti.sysbios.misc/Stats.oem3
Stats.sem3,copy : package/lib/lib/debug/ti.sysbios.misc/Stats.sem3
package_ti.sysbios.misc.oe674,copy : package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.oe674
package_ti.sysbios.misc.se674,copy : package/lib/lib/debug/ti.sysbios.misc/package/package_ti.sysbios.misc.se674
Stats.oe674,copy : package/lib/lib/debug/ti.sysbios.misc/Stats.oe674
Stats.se674,copy : package/lib/lib/debug/ti.sysbios.misc/Stats.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sysbios_misc
ti_sysbios_misc.tar: package/package.bld.xml
ti_sysbios_misc.tar: package/package.ext.xml
ti_sysbios_misc.tar: package/package.rel.dot
ti_sysbios_misc.tar: package/build.cfg
ti_sysbios_misc.tar: package/package.xdc.inc
ti_sysbios_misc.tar: package.bld
ti_sysbios_misc.tar: package/package.cfg.xdc.inc
ti_sysbios_misc.tar: lib/debug/ti.sysbios.misc.aem3
ti_sysbios_misc.tar: package/package_ti.sysbios.misc.c
ti_sysbios_misc.tar: Stats.c
ti_sysbios_misc.tar: lib/debug/ti.sysbios.misc.ae674
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sysbios_misc.tar.dep
endif
package/rel/ti_sysbios_misc/ti/sysbios/misc/package/package.rel.xml:

ti_sysbios_misc.tar: package/rel/ti_sysbios_misc.xdc.inc package/rel/ti_sysbios_misc/ti/sysbios/misc/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sysbios_misc.xdc.inc,package/rel/ti_sysbios_misc.tar.dep)


release release,ti_sysbios_misc: all ti_sysbios_misc.tar
clean:: .clean
	-$(RM) ti_sysbios_misc.tar
	-$(RM) package/rel/ti_sysbios_misc.xdc.inc
	-$(RM) package/rel/ti_sysbios_misc.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.misc))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.misc)
endif
ifeq (,$(wildcard package/lib/lib/debug/ti.sysbios.misc/package))
    $(shell $(MKDIR) package/lib/lib/debug/ti.sysbios.misc/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sysbios.misc.pjt
