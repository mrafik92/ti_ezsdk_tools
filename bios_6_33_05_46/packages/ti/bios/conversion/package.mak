...
override PKGDIR = ti/bios/conversion
...
package/%.xdc.inc package/%_ti.bios.conversion.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.bios.conversion" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.bios.conversion $@
...
.PHONY: release,ti_bios_conversion
ti_bios_conversion.tar: package/package.bld.xml
ti_bios_conversion.tar: package/package.ext.xml
ti_bios_conversion.tar: package/package.rel.dot
ti_bios_conversion.tar: package/build.cfg
ti_bios_conversion.tar: package/package.xdc.inc
ti_bios_conversion.tar: package.bld
ti_bios_conversion.tar: bios5
ti_bios_conversion.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_bios_conversion.tar.dep
endif
package/rel/ti_bios_conversion/ti/bios/conversion/package/package.rel.xml:

ti_bios_conversion.tar: package/rel/ti_bios_conversion.xdc.inc package/rel/ti_bios_conversion/ti/bios/conversion/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_bios_conversion.xdc.inc,package/rel/ti_bios_conversion.tar.dep)


release release,ti_bios_conversion: all ti_bios_conversion.tar
clean:: .clean
	-$(RM) ti_bios_conversion.tar
	-$(RM) package/rel/ti_bios_conversion.xdc.inc
	-$(RM) package/rel/ti_bios_conversion.tar.dep
