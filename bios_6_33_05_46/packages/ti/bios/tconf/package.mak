...
package/%.xdc.inc package/%_ti.bios.tconf.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.bios.tconf" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.bios.tconf $@
...
.PHONY: release,ti_bios_tconf
ti_bios_tconf.tar: package/package.bld.xml
ti_bios_tconf.tar: package/package.ext.xml
ti_bios_tconf.tar: package/package.rel.dot
ti_bios_tconf.tar: package/build.cfg
ti_bios_tconf.tar: package/package.xdc.inc
ti_bios_tconf.tar: package.bld
ti_bios_tconf.tar: bios.xs
ti_bios_tconf.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_bios_tconf.tar.dep
endif
package/rel/ti_bios_tconf/ti/bios/tconf/package/package.rel.xml:

ti_bios_tconf.tar: package/rel/ti_bios_tconf.xdc.inc package/rel/ti_bios_tconf/ti/bios/tconf/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_bios_tconf.xdc.inc,package/rel/ti_bios_tconf.tar.dep)


release release,ti_bios_tconf: all ti_bios_tconf.tar
clean:: .clean
	-$(RM) ti_bios_tconf.tar
	-$(RM) package/rel/ti_bios_tconf.xdc.inc
	-$(RM) package/rel/ti_bios_tconf.tar.dep
